...
public class Sprite {
	private String front_default; // Imagen del pokemon por defecto
	private String front_shiny; // Imagen del pokemon variocolor
	private String front_female; // Imagen del pokemon femenino
	private String front_shiny_female; // Imagen del pokemon frente variocolor femenino
	private String back_default; // Imagen del pokemon vista atras
	private String back_shiny; // Imagen del pokemon vista atras variocolor
	private String back_female; // Imagen del pokemon vista atras femenino
	private String back_shiny_female; // Imagen del pokemon vista atras variocolor femenino
